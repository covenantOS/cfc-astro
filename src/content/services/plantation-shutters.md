...
- Free in-home consultation. We come to your home with samples, assess each window individually, and discuss your priorities for each space. We measure on-site and explain the options honestly including when we think a different treatment might be better for a particular window.
- Detailed measurement and quote. Every measurement is taken by our team, not estimated. We document each window's specifications and provide a written quote covering the full cost product, hardware, and installation.
...
- Professional installation. We install and level every shutter. We adjust the louver tension so they operate smoothly. We confirm the fit in your room before we consider the job done.
...
1. Free in-home consultation. We come to your St. Pete home with material samples, finish swatches, hinge hardware, and louver-size mockups so you can compare 2½-inch, 3½-inch, and 4½-inch louvers against your actual window. Typically one hour, no sales pressure, no deposit required to start.

2. Laser measurement and photo documentation. Every opening is measured to 1/16 inch. Specialty shapes (arches, hexagons, bays) get a physical template taken on-site, not estimated off a drawing. Photos of the opening, sill, and adjacent trim go into your file so installers have the full context.

3. Order placed and built. You approve final specs, frame style, louver size, finish color, mount type, tilt control. Lead time: 3-5 weeks for standard rectangular, 5-7 weeks for specialty shapes and motorized. We call when your shutters ship to the local warehouse for final QC before install day.

4. Installation. Two-person crew, one-day install for most whole-home projects. We bring touch-up paint, extra slats, and the manufacturer warranty card. Drop cloths, cleanup, and a walk-through of operation and care are included. If anything needs a tweak, we handle it before we leave.
