...
export const AREA_PAGES: Record<string, AreaPageConfig> = {
  ...
  'west-st-pete': {
    ...
    challengesParagraphs: [
      ...
      'Oversized openings are also where <a href="/services/custom-blinds/">custom blinds</a> and <a href="/services/custom-banquettes/">built-in seating</a> get specified together, since a window wall usually sets the layout of the room around it. For a wider look at how <a href="/">Custom Fabric Creations</a> approaches west-side homes, our <a href="/blog/">St. Pete window treatment guides</a> go room by room.',
    ],
    challengesList: [
    ...
    treatments: [
      ...
      { title: 'Motorized Shades', href: '/services/motorized-shades/', body: 'Put the west-facing sliders on a schedule so they drop before the afternoon sun hits, on remote, app, or voice.' },
      { title: 'Outdoor Window Shades', href: '/services/outdoor-window-shades/', body: 'Exterior solar screens for lanais and pool cages, stopping the heat at the opening before it reaches the glass.' },
    ],
    ...
    localElements: {
      ...
      paragraphs: [
        '<a href="/" class="text-brand-600 hover:text-brand-500">Custom Fabric Creations</a> - West St. Pete is located at 3026 Central Ave Ste 551, St. Petersburg, FL 33712, inside The UPS Store at Union Central. It is one of our two St. Petersburg locations, and you can see the full range of <a href="/services/" class="text-brand-600 hover:text-brand-500">services we offer</a> or <a href="/contact/" class="text-brand-600 hover:text-brand-500">book a free in-home consultation</a> from anywhere in Pinellas County.',
